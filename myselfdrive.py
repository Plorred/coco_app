...
images = glob.glob(Path.join("data/test", "*.jpg"))
titles = {
1: u'person',
2: u'bicycle',
3: u'car',
...
def main():
    ...
    app_mode = st.sidebar.selectbox("Выберите что сделать",
        ["О программе", "Запуск приложения", "Исходный код"])
...
def object_selector(img, precision):
